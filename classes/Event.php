...
class Event extends MysqlEntity{
    ...
    protected $id,$title,$guid,$content,$description,$pubdate,$link,$feed,$category,$creator,$unread,$favorite;
...
function truncate_title($string,$length=255,$append="&hellip;") {
  $string = trim($string);
...
// mb_strimwidth("Hello World", 0, 10, "...");
    function setTitle($title){
        $this->title = mb_strimwidth($title,0,250,"(...)");
    }
